...
const ElButton = document.querySelector('button'); */ //console.log(JSON.parse(localStorage.getItem('feedback-form-state')).email);
ElForm.addEventListener("input", (0, _lodashThrottleDefault.default)(handleInput, 500));
...
ElForm.elements.email.value = JSON.parse(localStorage.getItem("feedback-form-state")).email || "";
ElForm.elements.message.value = JSON.parse(localStorage.getItem("feedback-form-state")).message || "";
